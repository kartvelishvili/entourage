      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {items.map(item => (
          <div key={item.id} className="bg-gray-900 border border-gray-800 rounded-2xl overflow-hidden">
            <div className="aspect-[9/12] bg-gray-800">{item.thumbnail && <img src={item.thumbnail} alt="" className="w-full h-full object-cover" />}</div>
            <div className="p-4">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm px-4">
          <div className="bg-gray-900 border border-gray-800 rounded-2xl w-full max-w-lg shadow-2xl">
            ...
            <div className="p-6 space-y-4">
              ...
              <ImageUpload label="თამბნეილი" value={editing.thumbnail || ''} onChange={url => setEditing({ ...editing, thumbnail: url })} />
              <div>
